    ...
    prompts: [
      {
        ...
        name: "name",
        message:
          'Plugin name (e.g. bar-chart, pie-chart). \"custom-plugin-\" will be prepended automatically:',
      },
    ],
    actions: [
      {
      ...
      {
        type: "add",
        path: "src/features/plugins/custom-plugin-{{kebabCase name}}/src/{{pascalCase name}}.module.css",
        templateFile: "plop-templates/plugin/Component.module.css.hbs",
      },
      {
        type: "add",
      ...
      },
      {
        ...
        template:
          "import '@/features/plugins/custom-plugin-{{kebabCase name}}/src';",
      },
    ],
  });
};
